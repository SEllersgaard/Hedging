...
deltaMINUS2 = zeros(Jq+1,Js+1,Jt2);
sellLimit2 = zeros(Jq+1,Js+1,Jt2);
sellMarket2 = zeros(Jq+1,Js+1,Jt2);
...
h1 = surf(stock(low:dxx:high),time(1:dyy:end),Upper(1:dyy:end-tmin,low:dxx:high));
%set(h1,'LineStyle','none')
set(h1,'FaceAlpha',topalpha)
%set(h1,'FaceColor',[53/255 42/255 134/255],'FaceAlpha',topalpha)
set(h1,'FaceColor',ucl,'FaceAlpha',topalpha)
...
h2 = surf(stock(1:dxx:high),time(1:dyy:end),Lower(1:dyy:end-tmin,1:dxx:high));
%set(h2,'LineStyle','none')
set(h2,'FaceAlpha',botalpha)
%colormap(flipud(colormap(summer)))
%set(h2,'FaceColor',[166/255 191/255 106/255],'FaceAlpha',topalpha2)
set(h2,'FaceColor',lcl,'FaceAlpha',topalpha2)
freezeColors
ylabel('TTM   ','FontSize',12)
xlabel('Stock Price   ','FontSize',12)
zlabel('Inventory Level  ','FontSize',12)
...
set(h1,'FaceAlpha',topalpha2)
%set(h1,'FaceColor',[53/255 42/255 134/255],'FaceAlpha',topalpha2)
set(h1,'FaceColor',ucl,'FaceAlpha',topalpha2)
hold on
h2 = surf(stock(low:dxx:high),time(1:dyy:end),Lower(1:dyy:end-tmin,low:dxx:high));
%set(h2,'LineStyle','none')
set(h2,'FaceAlpha',botalpha2)
%set(h2,'FaceColor',[166/255 191/255 106/255],'FaceAlpha',topalpha2)
set(h2,'FaceColor',lcl,'FaceAlpha',topalpha2)
hold on
h3 = surf(stock(low:dxx:high),time(1:dyy:end),Mid(1:dyy:end-tmin,low:dxx:high));
%set(h3,'LineStyle','none')
set(h3,'FaceColor',mcl,'FaceAlpha',topalpha2)
%colormap(autumn)
ylabel('TTM   ','FontSize',12)
xlabel('Stock Price   ','FontSize',12)
zlabel('Inventory Level   ','FontSize',12)
...
X3 = smin:dxx*ds:smax;
Y3 = 0:dyy*dq:N;
h5=surf(X3,Y3,grid(21:dxx:end-20,1:dyy:end,Jt+1));
freezeColors
